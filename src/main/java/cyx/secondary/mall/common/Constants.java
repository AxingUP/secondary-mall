...
public class Constants {
    ...
    public final static String MALL_USER_SESSION_KEY = "secondaryMallUser";//session中user的key
    public final static String ADMIN_VERIFY_CODE_KEY = "verifyCode";//验证码key
    public final static String ADMIN_USER_SESSION_KEY = "adminUser";//session中user的key
