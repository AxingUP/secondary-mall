...
public class SecondaryMallCarouselController {

    @Resource
    SecondaryMallCarouselService secondaryMallCarouselService;

    @GetMapping("/carousels")
    public String carouselPage(HttpServletRequest request) {
        request.setAttribute("path", "secondary_mall_carousel");
        return "admin/secondary_mall_carousel";
    }
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(secondaryMallCarouselService.getCarouselPage(pageUtil));
    }
    ...
    public Result save(@RequestBody Carousel carousel) {
        ...
        String result = secondaryMallCarouselService.saveCarousel(carousel);
    ...
    public Result update(@RequestBody Carousel carousel) {
        ...
        String result = secondaryMallCarouselService.updateCarousel(carousel);
        if (ServiceResultEnum.SUCCESS.getResult().equals(result)) {
            return ResultGenerator.genSuccessResult();
        } else {
            return ResultGenerator.genFailResult(result);
    ...
    public Result info(@PathVariable("id") Integer id) {
        Carousel carousel = secondaryMallCarouselService.getCarouselById(id);
        if (carousel == null) {
    ...
    public Result delete(@RequestBody Integer[] ids) {
        ...
        if (secondaryMallCarouselService.deleteBatch(ids)) {
            return ResultGenerator.genSuccessResult();
        } else {
