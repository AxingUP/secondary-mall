...
public class SecondaryMallGoodsIndexConfigController {
    ...
    public String indexConfigsPage(HttpServletRequest request, @RequestParam("configType") int configType) {
        ...
        return "admin/secondary_mall_index_config";
    }
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(secondaryMallIndexConfigService.getConfigsPage(pageUtil));
    }
    ...
    public Result save(@RequestBody IndexConfig indexConfig) {
        if (Objects.isNull(indexConfig.getConfigType())
          ...
          String result = secondaryMallIndexConfigService.saveIndexConfig(indexConfig);
    ...
    public Result update(@RequestBody IndexConfig indexConfig) {
        ...
        String result = secondaryMallIndexConfigService.updateIndexConfig(indexConfig);
        if (ServiceResultEnum.SUCCESS.getResult().equals(result)) {
            return ResultGenerator.genSuccessResult();
        } else {
            return ResultGenerator.genFailResult(result);
    ...
    public Result info(@PathVariable("id") Long id) {
        IndexConfig config = secondaryMallIndexConfigService.getIndexConfigById(id);
        if (config == null) {
    ...
    public Result delete(@RequestBody Long[] ids) {
        ...
        if (secondaryMallIndexConfigService.deleteBatch(ids)) {
            return ResultGenerator.genSuccessResult();
        } else {
