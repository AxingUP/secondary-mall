...
public class SecondaryMallUserController {
    ...
    public String usersPage(HttpServletRequest request) {
        ...
        return "admin/secondary_mall_user";
    }
    ...
    public Result list(@RequestParam Map<String, Object> params) {
        ...
        return ResultGenerator.genSuccessResult(secondaryMallUserService.getSecondaryMallUsersPage(pageUtil));
    }
    ...
    public Result delete(@RequestBody Integer[] ids, @PathVariable int lockStatus) {
        ...
        if (secondaryMallUserService.lockUsers(ids, lockStatus)) {
