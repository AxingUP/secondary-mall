...
public class PersonalController {
    ...
    @Resource
    private SecondaryMallUserService secondaryMallUserService;
...
//    用户登录
    ...
    public Result login(@RequestParam("loginName") String loginName,
        ...
        String loginResult = secondaryMallUserService.login(loginName, MD5Util.MD5Encode(password, "UTF-8"), httpSession);
        //登录成功
    ...
    public Result register(@RequestParam("loginName") String loginName,
        ...
        String registerResult = secondaryMallUserService.register(loginName, password);
        //注册成功
    ...
    public Result updateInfo(@RequestBody MallUser mallUser, HttpSession httpSession) {
        SecondaryMallUserVO mallUserTemp = secondaryMallUserService.updateUserInfo(mallUser,httpSession);
